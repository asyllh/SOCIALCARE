...
struct INSTANCE {
    ...
    // col[3] = # of shifts for that nurse, col[4] = duration of total shift working time. (Note that for Ait H, nurseWorkingTimes is only nNurses x 3, and only the first three columns are needed - 12/11/2021 no longer the
    // case, ait H now also uses 5 columns.)
