...
coord1 = r'-1.0932713683349489,51.26244013391559'
coord2 = r'-1.1223542469709538,51.2517453438589'
coord3 = r'-1.1108495601022277,51.247216458376776'
coord4 = r'-1.11904,51.27989'
coord5 = r'-1.04517,51.26668'
# str_call = 'http://' + server + '/route/v1/driving/' + coord1 + ';' + coord2 + ';' + coord1 + '?overview=full&geometries=geojson'
# str_call = 'http://' + server + '/route/v1/driving/' + coord1 + ';' + coord3 + '?overview=full&geometries=geojson'
...
# str_call = 'http://localhost:5000/table/v1/driving/-1.0932713683349489,51.26244013391559;-1.1223542469709538,51.2517453438589;-1.1108495601022277,51.247216458376776;-1.11904,51.27989;-1.04517,51.26668?annotations=distance,duration'
str_call = 'http://' + server + '/table/v1/driving/' + coord1 + ';' + coord2 + ';' + coord3 + ';' + coord4 + ';' + coord5 + '?annotations=distance,duration'
r = requests.get(str_call)
d = r.json()
# print('distance: ', d['routes'][0]['distance'])
# print('duration: ', d['routes'][0]['duration'])
print('distances: ')
print(d['distances'])
print(type(d['distances']))
print('durations: ')
print(d['durations'])
# print(d)


# -1.0932713683349489,51.26244013391559
# -1.1223542469709538,51.2517453438589
# -1.1108495601022277,51.247216458376776
# -1.11904,51.27989
# -1.04517,51.26668

# 51.26244013391559, -1.0932713683349489
# 51.2517453438589, -1.1223542469709538
# 51.247216458376776, -1.1108495601022277
# 51.27989, -1.11904
# 51.26668, -1.04517
# print(d)
