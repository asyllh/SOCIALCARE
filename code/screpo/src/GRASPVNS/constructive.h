...
MODULE_API int python_entry(int nJobs_data, int nNurses_data, int nSkills_data, int verbose_data, float MAX_TIME_SECONDS, int tw_interval_data, bool exclude_nurse_travel_data,
                            double* od_data, double* nurse_travel_from_depot, double* nurse_travel_to_depot, int* unavail_matrix_data, int* nurse_unavail_data, int* nurseWorkingTimes_data,
                            int* jobTimeInfo_data, int* jobRequirements_data, int* nurseSkills_data, int* solMatrixPointer, int* doubleService, int* dependsOn, int* mk_mind, int* mk_maxd,
                            int* capabilityOfDoubleServices, double* prefScore, double* algorithmOptions_data, double* timeMatrixPointer, double* nurseWaitingTimePointer,
