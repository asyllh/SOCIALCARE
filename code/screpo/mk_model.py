...
if __name__ == '__main__':
	print('Running Test for the MK model...')
	...
	# cfile = 'saved_InstanzCPLEX_HCSRP_10_8.mat'
	...
	file_list_mat = ['saved_InstanzCPLEX_HCSRP_50_1.mat']

	for cfile in file_list_mat:
		matfile = directory_mat + cfile
		nbNodes, nbVehi, nbServi, r, DS, a, x, y, d, p, mind, maxd, e, l = MK.read_from_matfile(matfile)
		obj_value, status = solve_mk_model(nbNodes, nbVehi, nbServi, r, DS, a, x, y, d, p, mind, maxd, e, l)
		f = open('allmodels_solved.txt', 'a')
