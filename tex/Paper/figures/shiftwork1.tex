...
% Original job - duration 2.75, arrival 1.25, start TW 1, end TW 1.5, end 4
\draw [thick, tRed] (1,3) -- (4,3); % line for duration of original job, length 3, includes start of TW
\draw [thick, tRed] (1,2.85) -- (1,3.15); % vertical line for start of TW 
\draw [thick, tRed] (1.5,2.85) -- (1.5,3.15); % vertical line for end of TW
\draw [fill=white, thick] (1.25,3) circle [radius = 0.08]; % original arrival time at job
...
\node at (1.625, 1.45) {\scriptsize{$w_{ij}$}};

% Tardiness
\draw [thick] (1.5, 1.35) -- (1.5, 1.1) -- (5, 1.1) -- (5,1.35);
\node at (3.25, 0.95) {\scriptsize{$z_j$}};
...
\node at (1.25, 3.77) {\scriptsize{original}};
\node at (1.25, 3.52) {\scriptsize{$a(i,j)$}};
\draw [thick, tRed, ->] (1.25, 3.4) -- (1.25, 3.15);
\node at (0.95, 2.65) {\scriptsize{$e_j$}};
\node at (1.55, 2.65) {\scriptsize{$l_j$}};
\node at (5.45, 3.77) {\scriptsize{new}};
\node at (5.45, 3.52) {\scriptsize{$a(i,j)$}};
