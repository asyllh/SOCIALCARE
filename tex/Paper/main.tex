...
\begin{table}
	\centering
	\caption{Performance of the \comp{GRASP algorithm} (average of best and average results) compared to the AVNS algorithm presented in \citet{mankowska2014} (\emph{mk\_avns}) for the instance groups \emph{A} -- \emph{G}. Figures in bold indicate the best results for each instance group. \comp{mk only 2dp, why?}}
...
\comp{GRASP} clearly outperforms AVNS in the majority of instances, especially on those of larger sizes.
